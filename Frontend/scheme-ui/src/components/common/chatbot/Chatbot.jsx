...
const ChatBot = ({ schemeId }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        setIsLoading(true);
        // console.log(schemeId,language);
        // console.log("User Message:", `${import.meta.env.VITE_BACKEND_URL}/api/v1/chatbot/scheme-response`);
        try {
            const response = await axios.post(
                `${import.meta.env.VITE_BACKEND_URL}/api/v1/chatbot/scheme-response`,
                {
                    schemeId,
    ...
    return (
        <div className="fixed bottom-14 right-12 z-50">
            {!isOpen ? (
                ...
                <div className="bg-white rounded-lg shadow-xl w-[400px] h-[550px] flex flex-col">
