        ...
        return (
            <section className=" py-12 bg-gray-100">
                <div className="container mx-auto px-4">
                    ...
                    <div className="bg-gradient-to-r from-[#74B83E] to-green-500 rounded-xl shadow-sm p-8 text-center">
                        ...
                        <button
                            ...
                            className=" bg-white text-[#63ac27] px-10 py-3 rounded-xl font-semibold text-lg hover:bg-gray-50 transition-all duration-300 flex items-center justify-center mx-auto shadow-lg hover:shadow-xl"
                        >
                            Sign Up Now →
                        </button>
                    </div>
